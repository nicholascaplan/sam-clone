...
- [ ] **HIGH PRIORITY: Resolve the component-reference audit.** Prioritise keyboard-operable audio rows, complete modal semantics, catalogue-view semantics, shared focus treatment and role-based colour tokens.
